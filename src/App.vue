  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #0095ff">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"
        ><img
          src="./assets/car-arrow-right.png"
          alt="Logo"
          width="30"
          height="30"
        />EasyPark</a
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link custom-link" to="/marca/lista"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="25"
                fill="currentColor"
                class="bi bi-car-front-fill home-icon"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <li class="nav-item">
            <router-link class="nav-link custom-link" to="/modelo/lista"
              ><svg
                ...
                height="25"
                fill="currentColor"
                class="bi bi-briefcase-fill home-icon"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <li class="nav-item">
            <router-link class="nav-link custom-link" to="/condutor/lista"
              ><svg
                ...
                height="25"
                fill="currentColor"
                class="bi bi-person-fill home-icon"
                viewBox="0 0 16 16"
              >
                <path
          ...
          <li class="nav-item">
            <router-link class="nav-link custom-link" to="/veiculo/lista"
              ><svg
                ...
                height="25"
                fill="currentColor"
                class="bi bi-taxi-front home-icon"
                viewBox="0 0 16 16"
              >
                <path
