<template>
    <div class="modelo">
      <button type="button" class="btn btn-success mt-4" @click="registrarmodeloredirect">Cadastrar modelo</button>
  ...
  export default {
    methods: {
        registrarmodeloredirect() {
        this.$router.push('registrarmodelo');
      }
    }
  }
  </script>
